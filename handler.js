...
—◉ *إذا كنت تعتقد أن هذا خطأ ولديك دليل، فيمكنك الاتصال بمالك الروبوت لاستئناف التعليق.* —◉ *التواصل مع مالكه:* wa.me/967776050874
╚═════════════════════╝
               `.trim();
              m.reply(messageText);
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا من قبل صاحب الروبوت.*',
    owner: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا من قبل صاحب الروبوت.*',
    mods: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا من قبل المشرفين ومالك الروبوت.*',
    premium: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا من قبل المستخدمين الممتازين ومالك الروبوت.*',
    group: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا في مجموعات.*',
    private: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا في الدردشة الخاصة.*',
    admin: '*[ ℹ️ ] لا يمكن استخدام هذا الأمر إلا من قبل مسؤولي المجموعة.*',
    botAdmin: '*[ ℹ️ ] لاستخدام هذا الأمر ، من الضروري أن يكون الروبوت مسؤولًا للمجموعة.*',
    unreg: '*[ ℹ️ ] لاستخدام هذا الأمر يجب أن تكون مسجلاً.*\n\n*[ 💡 ] Use the command:* _#verify name.age_ *to register.*',
    restrict: '*[ ℹ️ ] تم تعطيل هذا الأمر من قبل صاحب الروبوت.*',
  }[type];
